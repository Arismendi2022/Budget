...
@section('content')
    ...
    <span class="back-links">
      <a title="Back to your Budget" class="ynab-logo launch_app_button" id="launch_app_button" href="{{ route('admin.budget') }}"><span>YNAB.</span></a>
      <a data-long-name="Back to Budget" data-short-name="Budget" title="Back to your Budget" class="back-to-parent back-to-budget launch_app_button"
				href="{{ route('admin.budget') }}"></a>
    </span>
		<h1>Account Settings</h1>
		<span id="close-link">
      <span></span><span></span>
        <a title="Back to your Budget" class="close launch_app_button" id="launch_app_button" href="{{ route('admin.budget') }}">×</a>
    </span>
	</header>
	<!---->
