				...
				<div id="ember233" class="accounts-toolbar">
					<div class="accounts-toolbar-left">
						<button class="ghost-button primary type-body add-transaction tooltip-relative-container"
							aria-describedby="add-transaction" type="button">
							<svg class="ynab-new-icon" width="16" height="16">
								<!---->
          ...
          <button disabled="" class="ghost-button primary type-body undo-button" aria-describedby="ember236"
            ...
            <svg class="ynab-new-icon" width="12" height="12">
              ...
              <use href="#icon_sprite_undo">
		              <symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_undo" fill="none" viewBox="0 0 24 24"><path
          ...
          <button disabled="" class="ghost-button primary type-body redo-button" type="button">
            <svg class="ynab-new-icon" width="12" height="12">
              ...
              <use href="#icon_sprite_redo">
		              <symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_redo" fill="none" viewBox="0 0 24 24"><path
											fill="currentColor" fill-rule="evenodd"
                ...
                Set view options like date range, reconciliation status, and more.
						...
						<div id="ember239" class="transaction-search js-transaction-search ">
							<div class="transaction-search-inner">
								...
								<input id="ember240" class="ember-text-field ember-view transaction-search-input"
          ...
          <span class="icon-wrapper">
            <svg class="ynab-new-icon ynab-flag-header" width="16" height="16">
              ...
              <use href="#icon_sprite_flag_fill">
								<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_flag_fill" fill="none" viewBox="0 0 24 24">
									<path fill="currentColor" fill-rule="evenodd" d="M23 19.5H1.5A1.5 1.5 0 0 1 0 18V6a1.5 1.5 0 0 1 1.5-1.5H23a1 1 0 0 1 .9 1.5l-3.3 5.8v.4l3.3 5.8a1 1 0 0 1-.9 1.5"
										clip-rule="evenodd"></path>
								</symbol>
							</use>
            </svg>
					...
					<div id="ember260" class="ynab-grid-header-cell js-ynab-grid-header-cell ynab-grid-cell-payeeName is-sorting"
			...
			<div id="ember263" class="ynab-grid-container">
				<div class="ynab-grid-body">
					<div class="ynab-grid-body-row-top" style="height:0px">
					...
					<div class="ynab-grid-body-row ynab-grid-body-parent" data-row-id="875410aa-b9f9-43ea-8ac1-bb59adf33de7">
						...
						<div class="ynab-grid-cell ynab-grid-cell-subCategoryName user-data" title="Inflow: Ready to Assign">
							<span class="indent">Inflow: Ready to Assign</span>&nbsp;
						</div>
						...
						<div class="ynab-grid-cell ynab-grid-cell-inflow user-data">
							<span class="user-data currency tabular-nums positive"><bdi>$</bdi>2.800,00</span>&nbsp;
						</div>
						...
						<div class="ynab-grid-cell ynab-grid-cell-cleared" data-register-area="Cleared">
							<button class="ynab-cleared is-cleared" title="Marking a transaction as 'cleared' means it has posted to your bank account." aria-label="This transaction is cleared"
								type="button">
