...
@section('content')
        ...
        <span class="user-data">
          <span class="user-data currency positive"><bdi>$</bdi>2.500,00</span>
        </span>
										...
										<div id="ember239" class="transaction-search js-transaction-search">
												<div class="transaction-search-inner">
														<div class="transaction-search-icon">
																<svg class="ynab-new-icon" width="12" height="12">
																		<!---->
																		<use href="#icon_sprite_search"></use>
																</svg>
														</div>
														<input id="ember240" class="ember-text-field ember-view transaction-search-input" placeholder="Search Ahorros"
