                ...
                <div class="shortcut-keys">
                  ...
                  <div class="shortcut-key ">
                    E
						...
						@endif
						@if($account->account_group === 'Loans')
							<button class="ynab-button secondary   loan-account-header-button loan-account-header-update-balance-button"
								type="button">
								Update Balance
							</button>
								...
								<use href="#icon_sprite_cleared_circle">
									<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_cleared_circle" fill="none"
										...
										<path fill="currentColor"
											d="M9.9 14.1q.9.9 2.1.9 1.4 0 2.2-1l1-.5q.6 0 1.1.4t.5 1-.3 1Q14.7 18 12 18q-2.5 0-4.2-1.8T6 12t1.8-4.2T12 6q2.7 0 4.5 2 .4.5.3 1 0 .7-.5 1.1a1 1 0 0 1-1 .4l-1.1-.5q-.8-1-2.2-1-1.2 0-2.1.9T9 12t.9 2.1">
										</path>
										<path fill="currentColor" fill-rule="evenodd"
							...
							<svg class="ynab-new-icon" width="16" height="16">
								...
								<use href="#icon_sprite_document_with_arrow_up">
									<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_document_with_arrow_up" fill="none"
										viewBox="0 0 24 24">
										<path fill="currentColor"
											d="M21 9.5A1.5 1.5 0 0 0 19.5 8h-5A1.5 1.5 0 0 1 13 6.5v-5A1.5 1.5 0 0 0 11.5 0h-7A1.5 1.5 0 0 0 3 1.5v21A1.5 1.5 0 0 0 4.5 24h6.8v-7.2h-2c-.1 0-.3-.2-.3-.4v-.2l2.7-4a.4.4 0 0 1 .6 0l2.6 4 .1.2-.2.3-.2.1h-1.8V24h6.7a1.5 1.5 0 0 0 1.5-1.5z">
										</path>
						...
						<div id="transaction_search" class="transaction-search js-transaction-search ">
							<div class="transaction-search-inner">
								...
								<input id="search_Input" class="ember-text-field ember-view transaction-search-input"
									placeholder="Search {{$account->nickname}}" aria-label="Find the transactions you're looking for..."
									title="Find the transactions you're looking for..." spellcheck="false" autocomplete="off" type="text">
								<!---->
									...
									<svg class="ynab-new-icon" width="12" height="12">
										...
										<use href="#icon_sprite_close_circle_fill">
											<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_close_circle_fill" fill="none"
												viewBox="0 0 24 24">
												<path fill="currentColor"
													d="M12 0a12 12 0 1 0 0 24 12 12 0 0 0 0-24m5.2 17.2a1.2 1.2 0 0 1-1.7 0L12 13.7l-3.5 3.5a1.2 1.2 0 0 1-1.7 0 1.2 1.2 0 0 1 0-1.7l3.5-3.5-3.5-3.5a1.2 1.2 0 0 1 0-1.7 1.2 1.2 0 0 1 1.7 0l3.5 3.5 3.5-3.5a1.2 1.2 0 0 1 1.7 0 1.2 1.2 0 0 1 0 1.7L13.7 12l3.5 3.5c.4.4.4 1.2 0 1.7">
												</path>
											</symbol>
										</use>
									</svg>
            ...
            <span class="icon-wrapper">
              <svg class="ynab-new-icon ynab-flag-header" width="16" height="16">
				...
				<div class="ynab-grid-add-rows">
					<div id="ember368" class="ynab-grid-body-row is-editing is-checked is-adding"
						data-row-id="8cbff179-e8fb-4554-acdc-cdc0ca6d8e98">
						<div class="ynab-grid-cell js-ynab-grid-cell ynab-grid-cell-checkbox">
							<button class="ynab-checkbox ynab-checkbox-button  is-checked" role="checkbox" aria-checked="true"
						...
						<div class="ynab-grid-cell js-ynab-grid-cell ynab-grid-cell-notification">
						</div>
                ...
                <use href="#icon_sprite_flag"></use>
						...
						<div class="ynab-grid-cell js-ynab-grid-cell ynab-grid-cell-date user-data">
							<input id="ember370"
								...
								autocomplete="off" spellcheck="false" placeholder="date" type="text">
