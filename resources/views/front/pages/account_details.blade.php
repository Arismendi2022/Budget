          ...
          {{ $account->nickname }}
				...
				<div class="accounts-header-actions">
					...
					<div class="reconcile-button-and-label">
						<button class="ynab-button primary secondary accounts-header-edit-account tooltip-relative-container" aria-describedby="ember142" type="button">
            <span role="tooltip" id="ember142" class="tooltip-content tooltip-below tooltip-right ">
              Edit Account
						...
						@if($account->account_group !== 'Loans')
							<button class="ynab-button primary accounts-header-reconcile tooltip-relative-container" aria-describedby="reconcile-button-tooltip" type="button">
								Reconcile <span role="tooltip" id="reconcile-button-tooltip" class="tooltip-content tooltip-below tooltip-right ">
                ...
                <div class="shortcut-keys">
                  ...
                  <div class="shortcut-key ">
                    E
						...
						@endif
						@if($account->account_group === 'Loans')
							<button class="ynab-button secondary   loan-account-header-button loan-account-header-update-balance-button" type="button">
								Update Balance
							</button>
			...
			@if($account->account_group !== 'Loans')
				<div class="accounts-header-balances">
					<div tabindex="0" aria-describedby="ember230" class="accounts-header-balances-amount accounts-header-balances-cleared tooltip-relative-container">
        <span class="user-data">
          <span class="user-data currency {{ $account->balance > 0 ? 'positive' : 'negative' }}">{{
            ...
            Link your account to your financial institution and import transactions without ever leaving YNAB.
					...
					<i> + </i>
					<div tabindex="0" aria-describedby="ember231" class="accounts-header-balances-amount accounts-header-balances-uncleared tooltip-relative-container">
        <span class="user-data">
          <span class="user-data currency zero"><bdi>$</bdi>0,00</span>
						...
						<div class="accounts-header-label">
							...
							Uncleared Balance <span role="tooltip" id="add-transaction" class="tooltip-content tooltip-below tooltip-left ">
            ...
            Enter Now.
					...
					<i> = </i>
					<div tabindex="0" aria-describedby="ember232" class="accounts-header-balances-amount accounts-header-balances-working tooltip-relative-container">
        <span class="user-data">
          <span class="user-data currency {{ $account->balance > 0 ? 'positive' : 'negative' }}">{{
            ...
            $account->balance < 0)) ? '−' : '' }}<bdi>$</bdi>{{
              number_format(abs($account->balance), 2, ',', '.') }}</span>
						...
						<div class="accounts-header-label">
							<!---->              Working Balance <span role="tooltip" id="add-transaction" class="tooltip-content tooltip-below tooltip-left ">
              ...
              <div class="payment-currency-label">
				...
				<div id="ember233" class="accounts-toolbar">
					<div class="accounts-toolbar-left">
						<button class="ghost-button primary type-body add-transaction tooltip-relative-container" aria-describedby="add-transaction" type="button">
							<svg class="ynab-new-icon" width="16" height="16">
								<!---->
							...
							Add Transaction <span role="tooltip" id="add-transaction" class="tooltip-content tooltip-above tooltip-left ">
            <div class="shortcut-tooltip">
                ...
                <div class="shortcut-key ">
                  N
						...
						@if($account->data_type !== 'Cash')
							<button class="ghost-button primary type-body accounts-toolbar-direct-import-link-account tooltip-relative-container" aria-describedby="ember234" type="button">
								<svg class="ynab-new-icon" width="16" height="16">
									<!---->
								...
								Link Account <span role="tooltip" id="add-transaction" class="tooltip-content tooltip-above tooltip-left ">
            Link your account to your financial institution and import transactions without ever leaving YNAB.
          </span>
							</button>
						@endif
						<button class="ghost-button primary type-body accounts-toolbar-file-import-transactions js-accounts-toolbar-file-import-transactions tooltip-relative-container"
            ...
            Import transactions from a bank file.
						...
						<!---->
						@if(in_array($account->data_type, ['CreditCard', 'LineOfCredit']))
							<button class="ghost-button primary type-body js-record-payment tooltip-relative-container" aria-describedby="ember86" type="button">
								<svg class="ynab-new-icon" width="16" height="16">
									<!---->
								...
								Record Payment <span role="tooltip" id="add-transaction" class="tooltip-content tooltip-above tooltip-right ">
          ...
          <button disabled="" class="ghost-button primary type-body undo-button" aria-describedby="ember236" type="button">
            <svg class="ynab-new-icon" width="12" height="12">
              <!---->
          ...
          <button disabled="" class="ghost-button primary type-body redo-button" type="button">
            ...
            Redo
					...
					<div class="accounts-toolbar-right">
						<button class="ghost-button primary is-dropdown type-body accounts-toolbar-view-options tooltip-relative-container" aria-describedby="ember238" type="button">
							View
            ...
            Set view options like date range, reconciliation status, and more.
						...
						<div id="transaction_search" class="transaction-search js-transaction-search ">
							<div class="transaction-search-inner">
								...
								<input id="search_Input" class="ember-text-field ember-view transaction-search-input" placeholder="Search {{$account->nickname}}"
											 aria-label="Find the transactions you're looking for..." title="Find the transactions you're looking for..." spellcheck="false" autocomplete="off"
											 type="text">
								<!---->
								<button class="transaction-search-cancel-icon js-transaction-search-cancel-icon" style="display: none" type="button">
									<svg class="ynab-new-icon" width="12" height="12">
										<!---->
			...
			@if($account->account_group !== 'Loans')
				<div id="ember256" class="ynab-grid-header ">
					<div class="ynab-grid-header-row">
						...
						<div class="ynab-grid-header-cell js-ynab-grid-header-cell ynab-grid-cell-notification" data-column="notification">
							<svg class="ynab-new-icon" width="16" height="16">
								<!---->
						...
						<div id="ember257" class="ynab-grid-header-cell js-ynab-grid-header-cell ynab-grid-cell-flag " data-column="flag">
            ...
            <span class="icon-wrapper">
              <svg class="ynab-new-icon ynab-flag-header" width="16" height="16">
                ...
                <use href="#icon_sprite_flag_fill">
                  <symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_flag_fill" fill="none" viewBox="0 0 24 24">
                    <path fill="currentColor" fill-rule="evenodd"
						...
						<div id="ember258" class="ynab-grid-header-cell js-ynab-grid-header-cell ynab-grid-cell-accountName " data-column="accountName">
							<div class="ynab-grid-header-column-sort-area">
								<!---->
						...
						<div id="ember259" class="ynab-grid-header-cell js-ynab-grid-header-cell ynab-grid-cell-date " data-column="date">
							<div class="ynab-grid-header-column-sort-area">
								<!---->
						...
						<div id="ember260" class="ynab-grid-header-cell js-ynab-grid-header-cell ynab-grid-cell-payeeName is-sorting" data-column="payeeName">
							<div class="ynab-grid-header-column-sort-area">
								<!---->
						...
						<div id="ember261" class="ynab-grid-header-cell js-ynab-grid-header-cell ynab-grid-cell-subCategoryName is-sorting" data-column="subCategoryName">
							<div class="ynab-grid-header-column-sort-area">
								<!---->
						...
						<div id="ember262" class="ynab-grid-header-cell js-ynab-grid-header-cell ynab-grid-cell-memo " data-column="memo">
							<div class="ynab-grid-header-column-sort-area">
								<!---->
						...
						<div id="ember263" class="ynab-grid-header-cell js-ynab-grid-header-cell ynab-grid-cell-outflow " data-column="outflow">
							<div class="ynab-grid-header-column-sort-area">
								<!---->
						...
						<div id="ember264" class="ynab-grid-header-cell js-ynab-grid-header-cell ynab-grid-cell-inflow " data-column="inflow">
							<div class="ynab-grid-header-column-sort-area">
								<!---->
						...
						<div id="ember265" class="ynab-grid-header-cell js-ynab-grid-header-cell ynab-grid-cell-balance " data-column="balance">
							<div class="ynab-grid-header-column-sort-area">
								<!---->
						...
						<div id="ember266" class="ynab-grid-header-cell js-ynab-grid-header-cell ynab-grid-cell-cleared " data-column="cleared">
							<div class="ynab-grid-header-column-sort-area">
								<svg class="ynab-new-icon" width="16" height="16">
				...
				<div class="ynab-grid-add-rows">
					<div id="ember368" class="ynab-grid-body-row is-editing is-checked is-adding" data-row-id="8cbff179-e8fb-4554-acdc-cdc0ca6d8e98">
            ...
            <span class="flag-pill-icon-container">
              <svg class="ynab-new-icon flag-pill-icon-none" width="16" height="16">
                ...
                <use href="#icon_sprite_flag">
									<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_flag" fill="none" viewBox="0 0 24 24"><mask id="path-1-inside-1_5064_5725" fill="#fff"><path
												fill-rule="evenodd" d="M23 19H1.5A1.5 1.5 0 0 1 0 17.5v-12A1.5 1.5 0 0 1 1.5 4H23a1 1 0 0 1 .9 1.5l-3.3 5.8v.4l3.3 5.8A1 1 0 0 1 23 19"
												clip-rule="evenodd"></path></mask><path fill="currentColor"
																																...
																																mask="url(#path-1-inside-1_5064_5725)"></path></symbol>
								</use>
              </svg>
            </span>
								<!---->
						...
						<div class="ynab-grid-cell js-ynab-grid-cell ynab-grid-cell-accountName user-data">
							<input id="ember369" class="accounts-text-field dropdown-text-field ember-text-field " autocomplete="off" spellcheck="false" placeholder="account" type="text">
						...
						<div class="ynab-grid-cell js-ynab-grid-cell ynab-grid-cell-date user-data">
							<input id="ember370" class="ember-text-field ember-view accounts-text-field dropdown-text-field ember-text-field " autocomplete="off" spellcheck="false"
						...
						<div class="ynab-grid-cell js-ynab-grid-cell ynab-grid-cell-payeeName user-data">
							<input id="ember371" class="accounts-text-field dropdown-text-field ember-text-field " autocomplete="off" spellcheck="false" placeholder="payee" type="text">
							<svg class="ynab-new-icon accounts-text-field-dropdown-icon" width="8" height="8">
								<!---->
								<use href="#icon_sprite_caret_down"></use>
							</svg>
						...
						<div class="ynab-grid-cell js-ynab-grid-cell ynab-grid-cell-subCategoryName user-data">
							<input id="ember372" class="accounts-text-field dropdown-text-field ember-text-field " autocomplete="off" spellcheck="false" placeholder="category" type="text">
						...
						<div class="ynab-grid-cell js-ynab-grid-cell ynab-grid-cell-memo user-data">
							<input id="ember373" class="ember-text-field ember-view accounts-text-field ember-text-field" placeholder="memo" type="text">
						</div>
						...
						<div class="ynab-grid-cell js-ynab-grid-cell ynab-grid-cell-cleared" data-register-area="Cleared">
							<button class="ynab-cleared is-uncleared" title="Marking a transaction as 'cleared' means it has posted to your bank account."
											aria-label="This transaction is not cleared" type="button">
								<svg class="ynab-new-icon is-uncleared-icon" width="12" height="12">
									<!---->
									<use href="#icon_sprite_cleared_circle"></use>
								</svg>
							</button>
						</div>
					</div>
				...
				<!---->
				<div id="ember263" class="ynab-grid-container">
					<div class="ynab-grid-body">
						...
						<div class="ynab-grid-body-row ynab-grid-body-parent" data-row-id="{{ $account->id }}">
							<div class="ynab-grid-cell ynab-grid-cell-checkbox">
								<button class="ynab-checkbox ynab-checkbox-button " role="checkbox" aria-checked="false" aria-label="This transaction" type="button">
									<svg class="ynab-new-icon ynab-checkbox-button-square" width="13" height="13">
										<!---->
										<use href="#icon_sprite_check">
											<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_check" fill="none" viewBox="0 0 24 24">
            ...
            <span class="user-data currency tabular-nums positive"><bdi>$</bdi>{{ number_format(abs($account->balance),
              2, ',', '.') }}</span>&nbsp;
							...
							<div class="ynab-grid-cell ynab-grid-cell-cleared" data-register-area="Cleared">
								<button class="ynab-cleared is-cleared" title="Marking a transaction as 'cleared' means it has posted to your bank account."
