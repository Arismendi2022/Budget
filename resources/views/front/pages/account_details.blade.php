          ...
          <div class="ynab-grid-body">
            ...
            <div class="ynab-grid-body-row ynab-grid-body-parent" data-row-id="875410aa-b9f9-43ea-8ac1-bb59adf33de7">
              ...
              <div class="ynab-grid-cell ynab-grid-cell-subCategoryName user-data" title="Inflow: Ready to Assign">
                <span class="indent">{{ in_array($account->data_type, ['CreditCard', 'LineOfCredit']) ? 'Category not needed' : 'Inflow: Ready to Assign' }}</span>&nbsp;
              </div>
              <div class="ynab-grid-cell ynab-grid-cell-memo user-data">
                <span></span>&nbsp;
              </div>
              <div class="ynab-grid-cell ynab-grid-cell-outflow user-data">
              <span class="user-data currency tabular-nums "> @if ( in_array($account->data_type, ['CreditCard', 'LineOfCredit']))
                  <bdi>$</bdi>{{ number_format(abs($account->balance), 2, ',', '.') }}
                @endif</span>&nbsp;
              </div>
              <div class="ynab-grid-cell ynab-grid-cell-inflow user-data">
              <span class="user-data currency tabular-nums positive"> @if ( !in_array($account->data_type, ['CreditCard', 'LineOfCredit']))
                  <bdi>$</bdi>{{ number_format(abs($account->balance), 2, ',', '.') }}
                @endif</span>&nbsp;
              </div>
              <div class="ynab-grid-cell ynab-grid-cell-balance">
                <span class="user-data currency tabular-nums positive"><bdi>$</bdi>{{ number_format(abs($account->balance), 2, ',', '.') }}</span>&nbsp;
              </div>
              <div class="ynab-grid-cell ynab-grid-cell-cleared" data-register-area="Cleared">
                <button class="ynab-cleared is-cleared" title="Marking a transaction as 'cleared' means it has posted to your bank account."
                        aria-label="This transaction is cleared"
                        type="button">
