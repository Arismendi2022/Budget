      ...
      groupContainers.forEach(container => {
        ...
        container.addEventListener('dragstart', (event) => {
          if(event.target.classList.contains('nav-account-row')) {
            ...
            selectedElementId = container.querySelector('.is-selected')?.dataset.accountId;
        ...
        container.addEventListener('drop', () => {
          ...
          // Restaurar la clase is-selected
          if(selectedElementId) {
            const selectedElement = container.querySelector(`[data-account-id="${selectedElementId}"]`);
            if(selectedElement) {
          ...
          Livewire.emit('updateOrder', groupType, order);
        });
      });
    });
