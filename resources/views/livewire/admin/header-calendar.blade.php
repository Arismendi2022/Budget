<div>
  <div class="budget-header-flexbox">
    ...
    <div class="budget-header-item budget-header-totals ">
      <div class="to-be-budgeted {{ $budgetTotal > 0 ? 'is-positive' : ($budgetTotal < 0 ? 'is-negative' : '') }}">
        @if ($budgetTotal < 0)
          {{-- Caso cuando el presupuesto es negativo --}}
          <div class="to-be-budgeted-heading-wrapper">
            <h1 id="ember-heading">
              <div class="to-be-budgeted-amount">
            <span class="user-data currency negative">
              −<bdi>{{ format_currency(abs($budgetTotal)) }}</bdi>
            </span>
          ...
          <button class="to-be-budgeted-auto-assign to-be-budgeted-button" aria-label="Fix This" type="button">
            <span class="label">Fix This</span>
          </button>
        @elseif ($budgetTotal > 0)
          <div class="to-be-budgeted-heading-wrapper">
            <h1 id="ember272-heading">
              <div class="to-be-budgeted-amount">
                <span class="user-data currency positive"><bdi>{{ format_currency($budgetTotal) }}</bdi></span>
                <svg class="ynab-new-icon" width="16" height="16" aria-hidden="true">
                  <!---->
                  <use href="#icon_sprite_info_circle_fill">
                    <symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_info_circle_fill" fill="none" viewBox="0 0 24 24">
          ...
          <button class="to-be-budgeted-auto-assign to-be-budgeted-button" aria-label="Assign" aria-describedby="ember272-heading" type="button">
        ...
        @else
          <div class="to-be-budgeted-heading-wrapper">
            <h1 id="ember9-heading">
              <div class="to-be-budgeted-amount">
                <span class="user-data currency zero"><bdi>{{ format_currency($budgetTotal) }}</bdi></span>
                <svg class="ynab-new-icon" width="16" height="16" aria-hidden="true">
                  <!---->
                  <use href="#icon_sprite_info_circle_fill">
                    <symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_info_circle_fill" fill="none" viewBox="0 0 24 24">
