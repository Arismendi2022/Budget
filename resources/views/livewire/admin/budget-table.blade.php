...
<section class="budget-table-container {{ $showProgressBar ? 'is-expanded' : '' }}" role="main">
	<div id="ember11" class="budget-table" role="treegrid">
			...
			<div class="budget-toolbar" role="row">
				...
				<div role="cell">
						<span class="recent-moves-open-modal-container">
							<button class="ghost-button primary type-body budget-toolbar-open-recent-moves"
								aria-describedby="recentMoves" type="button">
								<svg class="ynab-new-icon " width="16" height="16">
									<!---->
									<use href="#icon_sprite_clock_arrow_back">
										<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_clock_arrow_back" fill="none"
											viewBox="0 0 24 24">
											<path fill="currentColor" fill-rule="evenodd"
				...
				<div role="cell">
					<div class="segmented-control iconOnlyOption progress-bars-toggle" role="tablist" tabindex="0">
						<button wire:click="toggleProgressBar" class="segmented-control-button {{ $showProgressBar ? 'selected' : '' }}"
							aria-selected="{{ $showProgressBar ? 'true' : 'false' }}"
							role="tab" tabindex="-1"
							title="Progress Bars On" aria-label="Progress Bars On"
							aria-describedby="progressBarOn" type="button">
							<svg class="ynab-new-icon " width="12" height="12">
								<!---->
								<use href="#icon_sprite_progress_bars_on">
									<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_progress_bars_on" fill="none"
										viewBox="0 0 24 24">
										<path fill="currentColor"
						...
						<button wire:click="toggleProgressBar" class="segmented-control-button {{ !$showProgressBar ? 'selected' : '' }}" aria-selected="{{ !$showProgressBar ? 'true' : 'false'
					 }}" role="tab" tabindex="-1"
							title="Progress Bars Off" aria-label="Progress Bars Off"
							aria-describedby="progressBarOff" type="button">
							
							<svg class="ynab-new-icon " width="12" height="12">
								<!---->
								<use href="#icon_sprite_progress_bars_off">
									<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_progress_bars_off" fill="none"
										viewBox="0 0 24 24">
										<path fill="currentColor"
					...
					<div id="icon_sprite" style="display:block;width:0;height:0;position:absolute;top:0;right:0;overflow:hidden"
						tabindex="-1">
						<svg xmlns="http://www.w3.org/2000/svg">
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_arrow_down_to_surface" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_arrow_into_rectangle" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_arrow_out_of_box" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_arrows_circle_fill" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_arrows_horizontal" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_caret_left" fill="none" viewBox="0 0 24 24">
								<path fill="currentColor"
									d="M4.5 11 18 .2c.9-.7 2.1 0 2.1 1v21.4c0 1-1.2 1.7-2 1L4.4 13.1a1.4 1.4 0 0 1 0-2.2"></path>
							</symbol>
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_caret_right" fill="none" viewBox="0 0 24 24">
								<path fill="currentColor"
									d="M19.5 13 6.1 23.8c-.9.7-2.1 0-2.1-1V1.3c0-1 1.2-1.7 2-1l13.5 10.6a1.4 1.4 0 0 1 0 2.2"></path>
							</symbol>
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_caret_up" fill="none" viewBox="0 0 24 24">
								<path fill="currentColor"
									d="M13 4.5 23.8 18c.7.9 0 2.1-1 2.1H1.3c-1 0-1.7-1.2-1-2L10.9 4.4a1.4 1.4 0 0 1 2.2 0"></path>
							</symbol>
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_cash_in_envelope" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_cash_in_envelope_alt" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
									...
									clip-rule="evenodd"></path>
								<path fill="currentColor"
									d="M22.8 9.9h.8l.3-.1.1-.3V5.8l-.2-.6-.6-.2H.8l-.6.2-.2.6v3.7l.1.3h1.4l.1-.3V6.6h20.8v2.9l.1.3z"></path>
							</symbol>
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_check_circle" fill="none" viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
									d="M24 12a12 12 0 1 1-24 0 12 12 0 0 1 24 0m-1.8 0a10.2 10.2 0 1 1-20.4 0 10.2 10.2 0 0 1 20.4 0"
									clip-rule="evenodd"></path>
								<path fill="currentColor"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_check_circle_fill" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_checkmark_circle_multiple_fill" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
									...
									clip-rule="evenodd"></path>
								<path fill="currentColor"
									d="M22.7 10.5c0 6.7-5.5 12.2-12.2 12.2q-1.3 0-2.5-.3A10.5 10.5 0 0 0 22.4 8q.3 1.2.3 2.5"></path>
							</symbol>
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_chevron_down_circle_fill" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_chevron_left_circle" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_chevron_left_circle_fill" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_chevron_right_circle" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_chevron_right_circle_fill" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_chevron_up_circle_fill" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_circle_small_fill" fill="none"
								viewBox="0 0 24 24">
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_credit_card_exclamation_mark" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_credit_card_exclamation_mark_small" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_document_on_document_fill" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_document_with_arrow_down" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_exclamation_mark_circle_fill" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_exclamation_mark_triangle_fill" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_exclamation_octagon_fill" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_filter_circle" fill="none" viewBox="0 0 24 24">
								...
								<path fill="currentColor" fill-rule="evenodd"
									d="M24 12a12 12 0 1 1-24 0 12 12 0 0 1 24 0m-2 0a10 10 0 1 1-20 0 10 10 0 0 1 20 0"
									clip-rule="evenodd"></path>
							</symbol>
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_filter_circle_fill" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_pencil_with_lines" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_pie_chart_alt" fill="none" viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
									d="M12 24a12 12 0 1 0 0-24 12 12 0 0 0 0 24m0-1.7a10.3 10.3 0 1 0 0-20.6 10.3 10.3 0 0 0 0 20.6"
									clip-rule="evenodd"></path>
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_play_circle_fill" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
									d="M12 24a12 12 0 1 1 0-24 12 12 0 0 1 0 24m6-12.9L9 6.6a1 1 0 0 0-1.5.9v9a1 1 0 0 0 1.4.9l9-4.5a1 1 0 0 0 0-1.8"
									clip-rule="evenodd"></path>
							</symbol>
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_plus" fill="none" viewBox="0 0 24 24">
								<path fill="currentColor"
									d="M1 12c0-.8.7-1.5 1.5-1.5h19a1.5 1.5 0 0 1 0 3h-19c-.8 0-1.5-.7-1.5-1.5"></path>
								<path fill="currentColor"
									d="M12 23c-.8 0-1.5-.7-1.5-1.5v-19a1.5 1.5 0 1 1 3 0v19c0 .8-.7 1.5-1.5 1.5"></path>
							</symbol>
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_privacy_choices" fill="none" viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
									...
									clip-rule="evenodd"></path>
								<path fill="currentColor"
									d="M10.1 9.6c.2.2.3.5 0 .7l-3.4 4-.2.2-.6-.1-1.8-1.8v-.7h.7l1.4 1.4 3.2-3.7z"></path>
							</symbol>
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_question_mark_speech_bubble" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_snooze_slash" fill="none" viewBox="0 0 24 24">
								<path fill="currentColor" fill-rule="evenodd"
									d="m2.7 1.3 20 20a1 1 0 1 1-1.4 1.4l-20-20a1 1 0 1 1 1.4-1.4" clip-rule="evenodd"></path>
								<path fill="currentColor"
									d="m16 13-2-2 6.1-8.7h-5.4c-1.3 0-1.3-2.2 0-2.2h7.9c.4 0 .7.2.7.7v.7c0 .4-.3.6-.5 1L17 10.7h6c1.4 0 1.4 2.2 0 2.2h-7"></path>
								<path fill="currentColor" fill-rule="evenodd"
									d="M0 23c0 .7.3 1 1 1h11.2c1.7 0 1.7-2.9 0-2.9H4.3l5.7-8v-.2l-2-2c-.2-.1-.2 0-.2 0l-7.2 10c-.3.4-.6.8-.6 1.3z"
									clip-rule="evenodd"></path>
								<path fill="currentColor"
									d="M12.8 8c0-.7-.4-1-1-1h-1.7l2.3 2.5h.1c.2-.2.2-.4.2-.7zM1.4 9.7C-.3 9.9-.3 7 1.4 7H4l2.8 2.8z"></path>
							</symbol>
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_square_and_pencil" fill="none"
								viewBox="0 0 24 25">
								<path fill="currentColor" fill-rule="evenodd"
							...
							<symbol xmlns="http://www.w3.org/2000/svg" id="icon_sprite_subtract_circle_fill" fill="none"
								viewBox="0 0 24 24">
								<path fill="currentColor"
			...
			<div class="budget-table-header-labels budget-table-row-ul" role="row">
				...
				<div class="budget-table-cell-checkbox budget-table-row-li " role="columnheader" aria-colindex="1">
					<button wire:click="toggleAllCategories()" class="ynab-checkbox ynab-checkbox-button " role="checkbox"
						...
						type="button">
						<svg class="ynab-new-icon ynab-checkbox-button-square {{ empty($selectedCategories) ? '' : ($isMasterPartial ? 'is-partial' : 'is-checked') }}" width="13"
							height="13">
							<!---->
				...
				<div class="budget-table-cell-budgeted budget-table-row-li"
				...
				<div class="budget-table-cell-activity budget-table-row-li"
					title="It's the &quot;We spent how much on WHAT?!&quot; column." role="columnheader" aria-colindex="5">
					ACTIVITY
				</div>
				<div class="budget-table-cell-available budget-table-row-li"
		...
		<div class="budget-table-draggable">
			...
			@foreach($groups as $group)
				<div id="group-{{ $group->id }}" draggable="true"
					class="budget-table-row js-budget-table-row budget-table-row-ul is-master-category" role="row" aria-level="1"
					aria-expanded="true">
					...
					<div class="budget-table-cell-checkbox budget-table-row-li " role="cell" aria-colindex="1">
						<button wire:click="toggleGroup({{ $group->id }})" class="ynab-checkbox ynab-checkbox-button " role="checkbox"
							...
							<svg
								class="ynab-new-icon ynab-checkbox-button-square {{ $this->isGroupChecked($group->id) ? ($this->isGroupPartial($group->id) ? 'is-partial' : 'is-checked') : '' }}"
								width="13" height="13">
								<!---->
					...
					<div class="budget-table-cell-name budget-table-row-li" role="rowheader" aria-colindex="3">
						...
						<button class="button budget-table-cell-add-category budget-table-cell-button " aria-label="Add Category" aria-describedby="addCategory"
							...
							<svg class="ynab-new-icon " width="14" height="14">
								<!---->
								<use href="#icon_sprite_plus_circle_fill">
									<svg xmlns="http://www.w3.org/2000/svg" id="icon_sprite_plus_circle_fill" fill="none"
										viewBox="0 0 24 24">
										<path fill="currentColor"
											d="M12 0a12 12 0 1 0 0 24 12 12 0 0 0 0-24m4.8 13.2h-3.6v3.6c0 .7-.5 1.2-1.2 1.2s-1.2-.5-1.2-1.2v-3.6H7.2c-.7 0-1.2-.5-1.2-1.2s.5-1.2 1.2-1.2h3.6V7.2c0-.7.5-1.2 1.2-1.2s1.2.5 1.2 1.2v3.6h3.6c.7 0 1.2.5 1.2 1.2s-.5 1.2-1.2 1.2"></path>
									</svg>
...
@push('scripts')
	<script>
		...
		//Script para colapsar/expandir grupo y subgrupos
		document.addEventListener('DOMContentLoaded', () => {
