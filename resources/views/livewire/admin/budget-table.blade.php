		...
		<div class="budget-toolbar" role="row">
			...
			<div role="cell">
				<div class="segmented-control iconOnlyOption progress-bars-toggle" role="tablist" tabindex="0">
					<button class="segmented-control-button selected" aria-selected="true" role="tab" tabindex="-1"
					...
					<button class="segmented-control-button " aria-selected="false" role="tab" tabindex="-1"
