...
<body data-page="authentications#new" data-ynab-device="web" class="theme-dark {{ $backgroundClass ?? 'body-background--dark-shapes' }}">
<div class="page-wrapper">
	<header class="authentications-page-header">
		<div class="authentications-page-header__inner">
			<a title="Back to ynab.com" class="authentications-page-header__logo" href="https://ynab.test"><img alt=""
